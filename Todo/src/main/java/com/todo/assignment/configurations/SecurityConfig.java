package com.todo.assignment.configurations;
...
import com.todo.assignment.filter.JwtAuthFilter;
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception
	{
		return http.csrf().disable().cors().and().
			authorizeHttpRequests().requestMatchers("/authentication","/signup").permitAll().and().
